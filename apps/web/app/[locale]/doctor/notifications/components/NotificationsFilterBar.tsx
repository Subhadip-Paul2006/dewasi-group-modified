...
export function NotificationsFilterBar({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-xs transition-colors dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="flex flex-1 flex-col gap-2.5 sm:flex-row sm:items-center md:justify-end">
          ...
          <div className="relative min-w-[170px]">
            ...
            <select
              ...
              className="w-full rounded-lg border border-slate-200 bg-slate-50 py-1.5 pl-8 pr-8 text-xs font-medium text-slate-700 transition-colors focus:border-blue-500 focus:outline-hidden focus:ring-1 focus:ring-blue-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200"
            >
