...
export function RequestsTabs({
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="inline-flex rounded-xl border border-slate-200 bg-slate-100/80 p-1 dark:border-slate-800 dark:bg-slate-900">
        <button
          type="button"
        ...
        >
          ...
          {pendingReceivedCount > 0 ? (
            ...
            <span className="ml-1 rounded-full bg-slate-200 px-1.5 py-0.2 text-[10px] font-medium text-slate-700 dark:bg-slate-700 dark:text-slate-300">
              {receivedCount}
            </span>
          )}
        </button>
