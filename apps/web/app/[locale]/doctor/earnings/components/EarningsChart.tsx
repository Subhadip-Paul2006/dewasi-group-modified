        ...
        {breakdown.map((item) => {
          ...
          return (
            <div key={item.clinicId} className="space-y-1.5">
              ...
              <div className="relative flex h-5 w-full items-center rounded-lg bg-slate-100 p-1 dark:bg-slate-800 overflow-hidden">
                <div
                  className="h-full rounded-md bg-gradient-to-r from-blue-600 to-emerald-500 transition-all duration-700"
