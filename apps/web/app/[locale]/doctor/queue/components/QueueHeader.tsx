      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {clinics.length > 0 && (
          <div className="relative flex items-center">
            ...
            <select
              ...
              className="h-9 rounded-lg border border-slate-200 bg-slate-50 pl-9 pr-8 text-xs font-semibold text-slate-800 shadow-xs transition hover:bg-slate-100/70 focus:border-blue-500 focus:outline-hidden dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-750"
            >
              {clinics.map((c) => (
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            className="h-9 rounded-lg border border-slate-200 bg-slate-50 pl-9 pr-3 text-xs font-semibold text-slate-800 shadow-xs transition hover:bg-slate-100/70 focus:border-blue-500 focus:outline-hidden dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-750"
          />
        </div>
        ...
        <button
          ...
          onClick={onRefresh}
          disabled={isFetching}
          className="inline-flex h-9 items-center justify-center gap-1.5 rounded-lg border border-slate-200 bg-slate-50 px-3 text-xs font-semibold text-slate-700 shadow-xs hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700/60 disabled:opacity-50"
