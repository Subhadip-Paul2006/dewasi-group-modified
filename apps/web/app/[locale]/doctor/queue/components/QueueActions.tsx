...
export function QueueActions({
  ...
  // Selected patient ID for emergency call (if user selects a patient from waiting queue)
  const [selectedEmergencyPatientId, setSelectedEmergencyPatientId] = useState<string>("");
  ...
  // Generic handler wrapper with toast feedback
  const handleAction = async (
    ...
    try {
      await mutation.mutateAsync({ doctorId, clinicId, date, body });
  ...
  return (
    <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-white p-5 shadow-xs transition-colors dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="mt-4">
          ...
          <div className="mt-2 grid grid-cols-2 gap-2 sm:grid-cols-4">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-blue-600 px-3 py-2.5 text-xs font-bold text-white shadow-xs hover:bg-blue-700 disabled:opacity-50"
            >
              {nextMutation.isPending ? (
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2.5 text-xs font-semibold text-slate-800 hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700/60 disabled:opacity-50"
            >
              {prevMutation.isPending ? (
                <Loader2 className="h-3.5 w-3.5 animate-spin" />
              ) : (
          ...
          <div className="mt-2 grid grid-cols-2 gap-2 sm:grid-cols-4">
            ...
            {isPaused ? (
              <button
                ...
                className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-emerald-600 px-3 py-2.5 text-xs font-bold text-white shadow-xs hover:bg-emerald-700 disabled:opacity-50"
              >
                {resumeMutation.isPending ? (
                  <Loader2 className="h-3.5 w-3.5 animate-spin" />
                ) : (
            ...
            <button
              ...
              className="col-span-2 inline-flex items-center justify-center gap-1.5 rounded-lg bg-rose-600 px-3 py-2.5 text-xs font-bold text-white shadow-xs hover:bg-rose-700 disabled:opacity-50 sm:col-span-2"
            >
              {emergencyMutation.isPending ? (
                <Loader2 className="h-3.5 w-3.5 animate-spin" />
              ) : (
      ...
      {/* 5. Emergency Intercept Confirmation Modal */}
      <ConfirmModal
