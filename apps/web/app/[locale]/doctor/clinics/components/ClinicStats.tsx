    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-white p-4 shadow-xs transition-colors dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="mt-3 flex items-baseline gap-2">
          ...
          <span className="text-[11px] text-slate-400">Connected Hubs</span>
        </div>
      ...
      <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-white p-4 shadow-xs transition-colors dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="mt-3 flex items-baseline gap-2">
          ...
          <span className="text-[11px] text-slate-400">Approved Links</span>
        </div>
        <p className="mt-2 text-[11px] text-slate-500 dark:text-slate-400">
      ...
      <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-white p-4 shadow-xs transition-colors dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="mt-3 flex items-baseline gap-2">
          ...
          <span className="text-[11px] text-slate-400">Distinct Cities</span>
        </div>
        <p className="mt-2 text-[11px] text-slate-500 dark:text-slate-400">
          Geographic practice footprint
        </p>
      </div>
    </div>
  );
