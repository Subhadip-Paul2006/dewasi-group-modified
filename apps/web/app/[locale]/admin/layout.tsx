  ...
  return (
    <div className="flex min-h-[400px] items-center justify-center">
      <div className="flex flex-col items-center gap-3">
        <div className="h-8 w-8 animate-spin rounded-full border-[2.5px] border-blue-600 border-t-transparent" />
...
function DesktopNavItem({
  ...
  return (
    <Link
      ...
      className={
        active
          ? "group flex items-center gap-3 rounded-xl bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-500 px-3 py-2.5 text-xs font-bold text-white shadow-md shadow-blue-500/20 transition-all"
...
function MobileFabButton({
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-500 text-white shadow-xl shadow-blue-600/30 hover:scale-105 active:scale-95 transition-all md:hidden"
    >
        ...
        <div className="flex items-center justify-between border-b border-slate-100 pb-4 dark:border-slate-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="rounded-full bg-blue-100 px-2 py-0.5 text-[9px] font-bold text-blue-800 dark:bg-blue-950/60 dark:text-blue-300">
                {userRole}
              </span>
            </div>
          </div>
                ...
                {section.items.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className={
                        active
                          ? "flex items-center gap-3 rounded-xl bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-500 px-3 py-2.5 text-xs font-bold text-white shadow-md shadow-blue-500/20"
