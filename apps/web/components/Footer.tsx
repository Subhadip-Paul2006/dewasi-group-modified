      ...
      <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-500">
            <li>
              <a href="mailto:support@doctorcontract.in" className="hover:text-[var(--color-primary)]">
        ...
        <span className="flex flex-col items-center gap-1.5 sm:flex-row sm:gap-3">
          <span>
            ...
            <a
              ...
              className="font-medium text-gray-500 underline decoration-dotted underline-offset-2 hover:text-[var(--color-primary)]"
            >
              Soumya Chatterjee
            </a>
          </span>
